...
export type ViewType = 'HOME' | 'AI_ORGANIZER' | 'MERGE' | 'IMG_TO_PDF' | 'SPLIT' | 'EDIT' | 'CONVERT' | 'STUDY' | 'EXCEL_TEMPLATE' | 'ORACLE' | 'CHAT' | 'PRICING' | 'LANDING_FACTURAS_EXCEL' | 'LANDING_GENERADOR_TEST' | 'LANDING_MODELO_TRIBUTARIO' | 'TEMPLATE_EDITOR' | 'AFFILIATES' | 'BLOG';
